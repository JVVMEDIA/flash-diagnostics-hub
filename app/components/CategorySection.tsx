    ...
    >
      <div id={category.id} className="scroll-mt-24">
        ...
        >
          ...
          <div className="flex items-start gap-3 sm:gap-5 pl-2">
            ...
            <div
              className={`shrink-0 text-emerald-400 mt-1 p-2 rounded-xl bg-emerald-500/10 border border-emerald-500/20 transition-transform duration-200 ${
                isOpen ? "rotate-180" : ""
              }`}
            >
              <ChevronDown size={20} />
        ...
        {skipMotion ? (
          isOpen && (
            <div className="mt-4 space-y-4 pl-0 md:pl-4 md:ml-3 border-l-0 md:border-l md:border-opacity-40" style={{ borderColor: accentColor }}>
              {category.overview && category.overview.length > 0 && (
                <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 px-4 sm:px-5 py-4">
