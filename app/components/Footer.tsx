      ...
      <div className="page-container flex flex-col items-center gap-6">
        ...
        <div className="w-full flex items-center justify-between gap-4">
          ...
          <button
            type="button"
            onClick={scrollToTop}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-sm font-medium text-emerald-300 hover:bg-emerald-500/20 hover:border-emerald-400/50 hover:text-emerald-200 transition-colors touch-manipulation shrink-0"
